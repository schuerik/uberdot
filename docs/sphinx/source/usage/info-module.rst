...
system you are on. At the moment the following functions are
implemented:

+---------------------+------------------------------------------------+
| Function            | Description                                    |
+=====================+================================================+
| ``distribution()``  | Returns the distribution name (eg “Ubuntu”,    |
|                     | “Antergos”)                                    |
+---------------------+------------------------------------------------+
...
+---------------------+------------------------------------------------+
| ``kernel()``        | Returns the release of the running kernel (eg  |
|                     | “4.19.4”)                                      |
+---------------------+------------------------------------------------+
| ``pkg_installed(pkg | Returns True if the package called             |
| _name)``            | ``pkg_name`` is installed                      |
+---------------------+------------------------------------------------+
